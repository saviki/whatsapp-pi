...
const fallback = {
    ...
    "menu.root.settings": "Settings",
    "menu.root.back": "Back",
    "menu.settings.title": "Settings",
    "menu.settings.brandVisibility": "Brand visibility",
    "menu.settings.brandVisibilityYes": "Brand visibility: Yes",
    "menu.settings.brandVisibilityNo": "Brand visibility: No",
    "menu.settings.brandVisibilitySet": "Brand visibility set to {value}",
...
const translations: Record<Locale, Partial<Record<Key, string>>> = {
    "pt-BR": {
        ...
        "menu.root.settings": "Configurações",
        "menu.root.back": "Voltar",
        "menu.settings.title": "Configurações",
        "menu.settings.brandVisibility": "Visibilidade da marca",
        "menu.settings.brandVisibilityYes": "Visibilidade da marca: Sim",
        "menu.settings.brandVisibilityNo": "Visibilidade da marca: Não",
        "menu.settings.brandVisibilitySet": "Visibilidade da marca definida para {value}",
    ...
    es: {
        ...
        "menu.root.settings": "Configuración",
        "menu.root.back": "Volver",
        "menu.settings.title": "Configuración",
        "menu.settings.brandVisibility": "Visibilidad de marca",
        "menu.settings.brandVisibilityYes": "Visibilidad de marca: Sí",
        "menu.settings.brandVisibilityNo": "Visibilidad de marca: No",
        "menu.settings.brandVisibilitySet": "Visibilidad de marca establecida en {value}",
        "menu.settings.back": "Volver",
    ...
    fr: {
        ...
        "menu.root.settings": "Paramètres",
        "menu.root.back": "Retour",
        "menu.settings.title": "Paramètres",
        "menu.settings.brandVisibility": "Visibilité de la marque",
        "menu.settings.brandVisibilityYes": "Visibilité de la marque : Oui",
        "menu.settings.brandVisibilityNo": "Visibilité de la marque : Non",
        "menu.settings.brandVisibilitySet": "Visibilité de la marque définie sur {value}",
        "menu.settings.back": "Retour",
